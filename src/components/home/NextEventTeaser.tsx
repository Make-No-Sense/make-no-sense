    ...
    <section className="bg-mid-gray py-12 sm:py-20 px-5 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-4xl">
        ...
        <div className="bg-char-black rounded-lg overflow-hidden border border-off-white/10">
          {event ? (
            <div className="border-l-4 border-truck-red p-5 sm:p-10">
              <h3 className="font-display text-off-white text-xl sm:text-3xl mb-5 leading-tight">
                {event.title}
              </h3>
          ...
          <div className="bg-mid-gray px-5 sm:px-10 py-4 sm:py-5 border-t border-off-white/10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
